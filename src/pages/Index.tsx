...
import { Bell, Settings, ShoppingCart, BarChart3, Layers, Shield, UserPlus, Wallet, Flame, Image, Zap } from "lucide-react";
...
const QUICK_ACTIONS = [
  ...
  { icon: Zap, label: "Alpha", path: "/alpha", color: "from-yellow-400 to-amber-500" },
